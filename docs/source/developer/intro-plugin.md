...
1. Download file `https://maven.gluu.org/maven/org/gluu/casa-base/4.1.Final/casa-base-4.1.Final.pom` and save it as `pom.xml`. If you are on linux, you can use `wget` passing `-O pom.xml`

1. `cd` to `shared` and download `https://maven.gluu.org/maven/org/gluu/casa-shared/4.1.Final/casa-shared-4.1.Final.pom` (save as `pom.xml`)

1. `cd` to `../app` and download `https://maven.gluu.org/maven/org/gluu/casa/4.1.Final/casa-4.1.Final.pom` saving again as `pom.xml`
