...
The fully functional code for this plugin can be found in the sample plugins repo [here](https://github.com/GluuFederation/casa-sample-plugins/clients-management). Once installed login as administrator, and go to `Administration console` > `clients ownership`.
