...
1. [Download the plugin](https://maven.gluu.org/maven/org/gluu/casa/plugins/authorized-clients/4.2.0.Final/authorized-clients-4.2.0.Final-jar-with-dependencies.jar)
