...
1. [Download the plugin](https://maven.gluu.org/maven/org/gluu/casa/plugins/custom-branding/4.2.0.Final/custom-branding-4.2.0.Final-jar-with-dependencies.jar)
...
See the [custom branding page](https://gluu.org/docs/casa/4.2/administration/custom-branding/) for full instructions.
