...
1. [Download the plugin](https://maven.gluu.org/maven/org/gluu/casa/plugins/custom-branding/4.1.0.Final/custom-branding-4.1.0.Final-jar-with-dependencies.jar)
