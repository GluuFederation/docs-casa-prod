...
1. [Download the plugin](https://ox.gluu.org/maven/org/gluu/casa/plugins/strong-authn-settings/4.3.0.Final/strong-authn-settings-4.2.0.Final-jar-with-dependencies.jar)
