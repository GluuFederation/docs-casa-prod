...
1. [Download the plugin](https://ox.gluu.org/maven/org/gluu/casa/plugins/strong-authn-settings/4.2.Final/strong-authn-settings-4.2.Final-jar-with-dependencies.jar)
